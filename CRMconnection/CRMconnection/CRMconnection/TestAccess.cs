...
using UOP.Portal.Gateway.Services.DAL;
...
namespace CRMConnection
{
   public class TestAccess
    ...
    public TestAccess()
       ...
       public void Execute()
       {
           Guid result = CreateContact("noor1010101", "n00r@test10101.com");

           List<Contact> listofresult = GetContactUsingLinqEarlyBound("noortestwq222");
           List<Entity> listofresult2 = GetContactUsingLinqLateBound("noortestwq222");
       }
